...
export const Hero = () => {
  return (
    <div className="relative flex aspect-[375/667] w-full items-center justify-center bg-gradient-to-b from-[#4A2C6B]/25 via-[#0D0E17] via-50% to-transparent to-70% sm:aspect-[640/700] lg:aspect-[1920/1080]">
